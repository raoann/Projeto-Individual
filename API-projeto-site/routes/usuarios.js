...
router.post('/autenticar', function(req, res, next) {
	...
	let instrucaoSql = `select * from usuario_gameswiki where usuario ='${login_backend}' and senha='${senha}'`; // select para localizar o usuario
...
router.post('/cadastrar', function(req, res, next) {
	...
	Usuario.create({
		...
		dataNascimento: req.body.data_nasc
	}).then(resultado => {
